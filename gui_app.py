...
class App:
    ...
    def _open_help(self) -> None:
        ...
        instructions = """
        CISCHECKER — ПРОВЕРКА КОДОВ МАРКИРОВКИ
        ...
        1. Настройте токен True API
           ...
           - Нужен установленный КриптоПро CSP + УКЭП (RuToken)
        ...
        2. Выберите товарную группу (выпадающий список сверху)
           - По умолчанию: Лёгкая промышленность
           - Если выбрана неверная ТГ — коды не будут найдены
        ...
        Формат выгрузки (10 колонок):
        - Штрихкод, GTIN, Бренд
        - Индекс картинки вида продукции
        - Статус, Количество, Владелец
        - Производитель, Дата ввода, Способ ввода

        Требования:
        - Российский IP (сервера ЧЗ геоблокируют зарубежные)
        - Python 3.8+, openpyxl
        - Для УКЭП: КриптоПро CSP + pywin32 (Windows)
        """
