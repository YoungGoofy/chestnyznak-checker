...
**Текущая версия:** `APP_VERSION = "1.0"` (в gui_app.py)
...
### Константы
- `APP_VERSION = "1.0"` — версия для проверки обновлений
...
- `_check_updates()` — проверка обновлений через GitHub Releases (в фоне)
